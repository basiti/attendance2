<?php
	$conn = mysqli_connect("localhost", "root", "", "studentstwo");
	...
	$sql = "SELECT * from attendance_table " . $queryCondition . " ORDER BY datesign desc";
...
<html>
    ...
    <div class="demo-content">
		<h2 class="title_with_link">teacher dashboard containing the list of students</h2>
...
<table class="table-content">
        ...
        <tr>
          ...
          <th width="50%"><span>students name</span></th>          
          <th width="20%"><span>datesign</span></th>	  
        </tr>
      </thead>
    <tbody>
	<?php
